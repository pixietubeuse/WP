...
wp_enqueue_style('itg-bootstrap-lightbox-css', ITG_PLUGIN_URL .'lightbox/bootstrap/css/ekko-lightbox.css');
wp_enqueue_script('itg-bootstrap-lightbox-js', ITG_PLUGIN_URL .'lightbox/bootstrap/js/ekko-lightbox.js', array('jquery'), '' , true);
